...
import fpt.plms.repository.entity.*;
import fpt.plms.repository.entity.Class;
import fpt.plms.service.constant.ServiceMessage;
import fpt.plms.service.constant.ServiceStatusCode;
import fpt.plms.repository.*;
import fpt.plms.repository.entity.*;
...
import fpt.plms.model.response.ClassByStudentResponse;
import fpt.plms.model.response.Response;
import fpt.plms.model.response.StudentInClassResponse;
import fpt.plms.model.dto.ClassDTO;
import fpt.plms.model.dto.LecturerDTO;
import fpt.plms.repository.ClassRepository;
import fpt.plms.repository.GroupRepository;
import fpt.plms.repository.LecturerRepository;
import fpt.plms.repository.SemesterRepository;
import fpt.plms.repository.StudentGroupRepository;
import fpt.plms.repository.StudentRepository;
import fpt.plms.repository.SubjectRepository;
